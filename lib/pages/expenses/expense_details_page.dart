...
class _BudgetDetailsPageState extends State<BudgetDetailsPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (_budgetData!['status'] == 'Active' ||
                ...
                SizedBox(height: _isMobile ? 20 : 24),
                _buildProgressSection(percentageUsed, progressColor, totalExpenses, budgetAmount),
              ],
  ...
  Widget _buildProgressSection(double percentageUsed, Color progressColor, double totalExpenses, double budgetAmount) {
    return Container(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    if (_canManageExpenses() && status == 'Pending' && !_isMobile) ...[
                      TextButton.icon(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Explain why this expense is considered fraudulent...',
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildDetailRow('Description', expense['expense_desc'] ?? 'No description'),
                    _buildDetailRow('Amount', _formatCurrency(amount)),
                    _buildDetailRow('Status', status),
                    _buildDetailRow('Created by', expense['created_by_name'] ?? 'Unknown'),
                    _buildDetailRow('Created on', _formatTimestamp(expense['created_at'])),
                    if (expense['updated_at'] != null)
                      _buildDetailRow('Last updated', _formatTimestamp(expense['updated_at'])),
              ...
              if (hasReceipt && receiptImage != null) ...[
                Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(12),
                    child: Image.memory(
                      Uri.parse('data:image/jpeg;base64,$receiptImage').data!.contentAsBytes(),
                      fit: BoxFit.contain,
